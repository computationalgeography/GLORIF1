...
#~     title = "Global Raster Map",
    title = expression("GLORIF1 - discharge (m"^3*"/s) - average 1979-2019"),
#~     x = "Longitude",
#~     y = "Latitude"
  ) +
#~   theme(
...
ggsave("/scratch-shared/edwin/_finalizing_glorif1/discharge_map_plot/glorif1_discharge.pdf", a, height = 8, width = 16, units = 'in', dpi = 1200)
