...
# using only stations with upstream area > 10,000 km2 (~4 pixels of PCR-GLOBWB)
...
map_filename = paste(outputDir, "grdc_gsim_map_final_v20260422.pdf", sep = "")
...
table_filename = paste(outputDir, "/performance_table_gsim_map_final_v20260422.csv", sep = "")
