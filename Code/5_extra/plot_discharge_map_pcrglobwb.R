...
raster_file <- "/scratch-shared/edwin/_finalizing_glorif1/discharge_map_plot/discharge_waterbodies2010_average_pcrglobwb_30min_original.map"
...
#~     title = "Global Raster Map",
    title = expression("PCR-GLOBWB (original, before RF) - discharge (m"^3*"/s) - average 1979-2019"),
#~     x = "Longitude",
#~     y = "Latitude"
  ) +
#~   theme(
...
ggsave("/scratch-shared/edwin/_finalizing_glorif1/discharge_map_plot/pcrglobwb_discharge.pdf", a, height = 8, width = 16, units = 'in', dpi = 1200)
