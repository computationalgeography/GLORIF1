...
raster_file <- "/scratch-shared/edwin/_finalizing_glorif1/discharge_map_plot/discharge_diff_avera_glorif1_minus_pcrglowb.map"
...
#~     name = "Value",  # Change legend title as needed
    name = expression("difference (m"^3*"/s)"),
...
#~     title = "Global Raster Map",
    title = expression("difference = (GLORIF1 - PCR-GLOBWB) (m"^3*"/s)"),
#~     x = "Longitude",
#~     y = "Latitude"
  ) +
#~   theme(
...
ggsave("/scratch-shared/edwin/_finalizing_glorif1/discharge_map_plot/difference_discharge.pdf", a, height = 8, width = 16, units = 'in', dpi = 1200)
