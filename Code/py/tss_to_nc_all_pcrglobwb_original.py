...
def create_nc(list_of_stations, input_csv_files_folder, input_file_pattern, output_nc_file):
    ...
    attributeDictionary['title'      ] = "PCR-GLOBWB monthly discharge output (original, before Random Forest)"
...
def main():
    ...
    # ~ input_file_pattern     = "pcr_rf_reanalysis_monthly_30arcmin_0p975_"
    # ~ output_nc_file         = "/scratch-shared/edwin/Data/output/netcdf/glorif1_discharge_0p975_30min_monthly.nc" 
    
    list_of_stations       = "/projects/0/dfguu/users/edwin/data/glorif1/original/version_1.0/preprocess/preprocess_grdc/stationLatLon_PCR.csv"
    input_csv_files_folder = "/projects/0/dfguu/users/edwin/data/glorif1/original/version_1.0/predictors/predictors/pcr_discharge/"
    input_file_pattern     = "pcr_discharge_"
    output_nc_file         = "/scratch-shared/edwin/Data/output/netcdf_pcrglobwb_original/pcrglobwb_discharge_original_30min_monthly.nc" 
