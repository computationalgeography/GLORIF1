...
def main():
    ...
    input_file_pattern     = "pcr_rf_reanalysis_monthly_30arcmin_0p500_"
    output_nc_file         = "/scratch-shared/edwin/Data/output/netcdf/glorif1_discharge_0p500_30min_monthly.nc" 
