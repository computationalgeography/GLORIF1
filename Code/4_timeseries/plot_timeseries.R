...
# - 2.5%
percentile_02p5_nc_filename = "/scratch-shared/edwin/_finalizing_glorif1/datasets_for_plots/test/glorif1_discharge_0p025_30min_monthly_correct.nc"
...
# - 97.5%
percentile_97p5_nc_filename = "/scratch-shared/edwin/_finalizing_glorif1/datasets_for_plots/test/glorif1_discharge_0p975_30min_monthly_correct.nc"
...
#~  geom_line(data = merged_table, mapping = aes(x = date, y = GLORIF1 ), color = "blue",  size = 0.35 ) +  # model results
 ...
 geom_line(data = merged_table, mapping = aes(x = date, y = GSIM), color =  "red",   linewidth = 1.00)  +  # measurement (gsim)
 geom_line(data = merged_table, mapping = aes(x = date, y = RSEG), color = "yellow", linewidth = 0.90)  +  # measurement (rseg)
