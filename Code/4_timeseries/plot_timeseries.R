...
# TODO: Use Mike's script to convert pcrglobwb time series 
pcrglobwb_filename = "" 
...
outplott <- ggplot()
outplott <- outplott +
 geom_ribbon(data = mergedTable, mapping = aes(ymin = perc_0p025, ymax = perc_0p975), fill = "grey70") +
 geom_line(data = mergedTable, mapping = aes(x = date, y = observation), color =  "red",  size = 0.90)  +  # measurement (gsim)
 geom_line(data = mergedTable, mapping = aes(x = date, y = observation), color = "green", size = 0.90) +  # measurement (rseg)
 geom_line(data = mergedTable, mapping = aes(x = date, y = simulation ), color = "black", size = 0.25) +  # original pcrglobwb
 geom_line(data = mergedTable, mapping = aes(x = date, y = simulation ), color = "blue",  size = 0.35 ) +  # model results

#~  geom_line(data = mergedTable, mapping = aes(x = date, y = observation), color =  "red") + # measurement
#~  geom_line(data = mergedTable, mapping = aes(x = date, y = simulation ), color = "blue") + # model results
#
